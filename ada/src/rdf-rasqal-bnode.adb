...
package body RDF.Rasqal.Bnode is
   ...
   type C_BNode_ID_Handler is access function (World: RDF.Rasqal.World.Rasqal_World_Handle;
                                               Data: chars_ptr;
                                               User_ID: chars_ptr)
                                               return Chars_Ptr
     with Convention=>C;
   ...
   function C_BNode_ID_Handle_Impl(World: RDF.Rasqal.World.Rasqal_World_Handle;
                                   Data: chars_ptr;
                                   User_ID: chars_ptr)
                                   return Chars_Ptr
      with Convention=>C;
   ...
   procedure rasqal_world_set_generate_bnodeid_handler (World: RDF.Rasqal.World.Rasqal_World_Handle; Data: chars_ptr; Handler: C_BNode_ID_Handler)
   ...
   function rasqal_world_set_default_generate_bnodeid_parameters (World: RDF.Rasqal.World.Rasqal_World_Handle;
                                                                  Prefix: Chars_Ptr;
                                                                  Base: int)
                                                                  return int
     with Import, Convention=>C;
