...
package body RDF.Redland.Memory is
   ...
   procedure Allocate(Pool : in out Redland_Storage_Pool;
   ...
   begin
      ...
      declare
         ...
         Ptr: constant My_Char_Pointer := My_Conv3(redland_alloc_memory(Size));
      begin
   ...
   begin
      ...
      begin
         redland_free_memory(My_Conv2.To_C_Pointer(Ptr));
      end;
   end;
