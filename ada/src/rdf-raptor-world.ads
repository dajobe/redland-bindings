...
package RDF.Raptor.World is
   ...
   not overriding procedure Set_Flag(Object: in out Raptor_World_Type_Without_Finalize;
                                     Flag: Raptor_Flag_Type;
                                     Value: Boolean);
   ...
   package Finalizer is new With_Finalization(Raptor_World_Type_Without_Finalize);
