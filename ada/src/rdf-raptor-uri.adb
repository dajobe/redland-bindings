...
package body RDF.Raptor.URI is
   ...
   function C_Raptor_New_Uri_From_Counted_String (World_Handle: RDF.Auxilary.Simple_Handled_Record.Access_Type;
   ...
   function C_Raptor_New_Uri_From_Uri_Local_Name (World_Handle: RDF.Auxilary.Simple_Handled_Record.Access_Type;
   ...
   function C_Raptor_New_Uri_From_Uri_Or_File_String(World_Handle: RDF.Auxilary.Simple_Handled_Record.Access_Type;
   ...
   function C_Raptor_New_Uri_Relative_To_Base_Counted(World_Handle: RDF.Auxilary.Simple_Handled_Record.Access_Type;
                                                      Base_URI: RDF.Auxilary.Simple_Handled_Record.Access_Type;
                                                      uri_string: char_array_access;
                                                      uri_len: size_t)
                                                     return RDF.Auxilary.Simple_Handled_Record.Access_Type
   ...
   function C_Raptor_New_Uri_From_ID(World_Handle: RDF.Auxilary.Simple_Handled_Record.Access_Type;
                                     Base_URI: RDF.Auxilary.Simple_Handled_Record.Access_Type;
   ...
   function C_Raptor_New_Uri_For_Rdf_Concept (World_Handle: RDF.Auxilary.Simple_Handled_Record.Access_Type;
