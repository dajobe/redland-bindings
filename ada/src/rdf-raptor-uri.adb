...
package body RDF.Raptor.URI is
   ...
   function C_Raptor_Uri_As_String(URI: RDF.Auxilary.Simple_Handled_Record.Access_Type)
                                   return chars_ptr
   ...
   function C_Raptor_Uri_To_Relative_Uri_String (Base_URI, Reference_URI: RDF.Auxilary.Simple_Handled_Record.Access_Type) return chars_ptr
   ...
   function C_Raptor_URI_Print (URI: RDF.Auxilary.Simple_Handled_Record.Access_Type; File: RDF.Auxilary.C_File_Access) return int
   ...
   function C_Raptor_URI_Get_World (URI: RDF.Auxilary.Simple_Handled_Record.Access_Type) return RDF.Auxilary.Simple_Limited_Handled_Record.Access_Type
