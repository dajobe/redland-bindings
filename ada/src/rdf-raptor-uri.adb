...
package body RDF.Raptor.URI is
   ...
   procedure C_Raptor_Free_URI (Handle: RDF.Auxilary.Simple_Limited_Handled_Record.Access_Type)
     with Import, Convention=>C, External_Name=>"raptor_free_uri";

   procedure Finalize_Handle(Object: URI_Type; Handle: RDF.Auxilary.Simple_Limited_Handled_Record.Access_Type) is
   begin
   ...
   function C_Raptor_New_Uri_From_Counted_String (World_Handle: RDF.Auxilary.Simple_Limited_Handled_Record.Access_Type;
                                                  ...
                                                  Length    : size_t)
                                                  return RDF.Auxilary.Simple_Limited_Handled_Record.Access_Type
   ...
   function C_Raptor_New_Uri_From_Uri_Local_Name (World_Handle: RDF.Auxilary.Simple_Limited_Handled_Record.Access_Type;
                                                  URI: RDF.Auxilary.Simple_Limited_Handled_Record.Access_Type;
   ...
   function C_Raptor_New_Uri_From_Uri_Or_File_String(World_Handle: RDF.Auxilary.Simple_Limited_Handled_Record.Access_Type;
                                                     Base_URI: RDF.Auxilary.Simple_Limited_Handled_Record.Access_Type;
   ...
   function C_Raptor_New_Uri_For_Xmlbase (Old_URI: RDF.Auxilary.Simple_Limited_Handled_Record.Access_Type)
                                          return RDF.Auxilary.Simple_Limited_Handled_Record.Access_Type
   ...
   function C_Raptor_New_Uri_For_Retrieval (Old_URI: RDF.Auxilary.Simple_Limited_Handled_Record.Access_Type)
                                          return RDF.Auxilary.Simple_Limited_Handled_Record.Access_Type
   ...
   function C_Raptor_Uri_Compare (URI1, URI2: RDF.Auxilary.Simple_Limited_Handled_Record.Access_Type) return int
   ...
   function C_Raptor_Uri_Equals (URI1, URI2: RDF.Auxilary.Simple_Limited_Handled_Record.Access_Type) return int
