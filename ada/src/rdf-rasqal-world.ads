...
package RDF.Rasqal.World is
   ...
   not overriding procedure Set_Log_Handler(World: Raptor_World_Type_Without_Finalize; Handler: access RDF.Raptor.Log.Log_Handler);

   type Warning_Level is range 0 .. 100;

   not overriding procedure Set_Warning_Level (World: Raptor_World_Type_Without_Finalize; Level: Warning_Level);

   not overriding function Get_Raptor (World: Raptor_World_Type_Without_Finalize) return RDF.Raptor.World.Raptor_World_Type_Without_Finalize;

   not overriding procedure Set_Raptor (World: Raptor_World_Type_Without_Finalize; Raptor_World: RDF.Raptor.World.Raptor_World_Type_Without_Finalize);

   not overriding function Guess_Query_Results_Format_Name (World: Raptor_World_Type_Without_Finalize;
