...
package body RDF.Raptor.Syntaxes is
   ...
   function raptor_world_is_parser_name(World: RDF.Raptor.World.Raptor_World_Handle; Name: char_array) return int
   ...
   function raptor_world_guess_parser_name (World: RDF.Raptor.World.Raptor_World_Handle;
   ...
   function raptor_world_is_serializer_name(World: RDF.Raptor.World.Raptor_World_Handle; Name: char_array) return int
     with Import, Convention=>C;
   ...
   function raptor_world_get_parser_description (World: RDF.Raptor.World.Raptor_World_Handle; Counter: unsigned) return Syntax_Description_Access
     with Import, Convention=>C;

   function raptor_world_get_serializer_description (World: RDF.Raptor.World.Raptor_World_Handle; Counter: unsigned) return Syntax_Description_Access
     with Import, Convention=>C;
