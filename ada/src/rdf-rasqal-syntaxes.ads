...
package RDF.Rasqal.Syntaxes is
   ...
   overriding function First (Object: Query_Language_Description_Iterator)
                              return Query_Language_Description_Cursor;
   overriding function Next (Object: Query_Language_Description_Iterator;
                             Position: Query_Language_Description_Cursor)
                             return Query_Language_Description_Cursor;

   overriding function First (Object: Query_Results_Format_Description_Iterator)
                              return Query_Results_Format_Description_Cursor;
   overriding function Next (Object: Query_Results_Format_Description_Iterator;
                             Position: Query_Results_Format_Description_Cursor)
                             return Query_Results_Format_Description_Cursor;

   not overriding function Create_Query_Language_Descriptions_Iterator (World: Rasqal_World_Type_Without_Finalize'Class)
                                                                        return Query_Language_Description_Iterator;
   not overriding function Create_Query_Results_Format_Descriptions_Iterator (World: Rasqal_World_Type_Without_Finalize'Class)
                                                                              return Query_Results_Format_Description_Iterator;
