...
package body RDF.Raptor.Namespace_Stack is
   ...
   procedure raptor_namespaces_clear (Stack: Namespace_Stack_Handle_Type)
   ...
   procedure raptor_free_namespaces (Stack: Namespace_Stack_Handle_Type)
     with Import, Convention=>C;
   ...
   function raptor_namespaces_start_namespace_full (Stack: Namespace_Stack_Handle_Type;
                                                      Prefix: chars_ptr;
                                                      URI: chars_ptr;
                                                      Depth: int)
                                                      return Int
   ...
   procedure raptor_namespaces_end_for_depth (Stack: Namespace_Stack_Handle_Type; Depth: int)
     with Import, Convention=>C;
   ...
   function raptor_namespaces_get_default_namespace (Stack: Namespace_Stack_Handle_Type) return Namespace_Handle_Type
     with Import, Convention=>C;
   ...
   procedure raptor_namespaces_start_namespace (Stack: Namespace_Stack_Handle_Type; Namespace: Namespace_Handle_Type)
     with Import, Convention=>C;
   ...
   function raptor_namespaces_namespace_in_scope (Stack: Namespace_Stack_Handle_Type;
   ...
   function raptor_namespace_stack_start_namespace (Stack: Namespace_Stack_Handle_Type;
                                                      NS: Namespace_Handle_Type;
                                                      New_Depth: int)
                                                      return Int
     with Import, Convention=>C;
