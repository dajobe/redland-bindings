...
--     use all type Parser_Type;
   ...
   function raptor_parser_get_locator (Parser: Handle_Type) return RDF.Raptor.Log.Locator_Handle_Type
      with Import, Convention=>C;
   ...
   procedure raptor_parser_parse_abort (Parser: Handle_Type)
      with Import, Convention=>C;
   ...
   function raptor_parser_parse_chunk (Parser: Handle_Type; Buffer: char_array; Len: size_t; Is_End: int) return int
      with Import, Convention=>C;
   ...
   function raptor_parser_parse_file (Parser: Handle_Type; URI, Base_URI: RDF.Raptor.URI.Handle_Type) return int
      with Import, Convention=>C;
   ...
   function raptor_parser_parse_file_stream (Parser: Handle_Type;
   ...
   function raptor_parser_parse_iostream (Parser: Handle_Type;
   ...
   function raptor_parser_parse_start (Parser: Handle_Type; URI: RDF.Raptor.URI.Handle_Type) return int
      with Import, Convention=>C;
   ...
   function raptor_parser_set_option (Parser: Handle_Type; Option: RDF.Raptor.Options.Raptor_Option; Value: chars_ptr; Int_Value: int) return int
      with Import, Convention=>C;
   ...
   function raptor_parser_get_option (Parser: Handle_Type;
                                      Option: RDF.Raptor.Options.Raptor_Option;
                                      String_P: String_P_Type;
                                      Integer_P: Int_P_Type) return int
      with Import, Convention=>C;

   function Get_Numeric_Option (Parser: Parser_Type_Without_Finalize; Option: RDF.Raptor.Options.Raptor_Option) return int is
      V: aliased int;
   begin
   ...
   function raptor_parser_get_accept_header (Parser: Handle_Type) return chars_ptr
      with Import, Convention=>C;
   ...
   procedure raptor_graph_mark_handler_impl (Data: chars_ptr; URI: RDF.Raptor.URI.Handle_Type; Flags: int) is
   ...
   function raptor_uri_filter_impl (Data: chars_ptr; URI: RDF.Raptor.URI.Handle_Type) return int is
   begin
   ...
   procedure raptor_parser_set_statement_handler (Parser: Handle_Type; Data: chars_ptr; Handler: raptor_statement_handler)
      with Import, Convention=>C;

   procedure raptor_parser_set_graph_mark_handler (Parser: Handle_Type; Data: chars_ptr; Handler: raptor_graph_mark_handler)
      with Import, Convention=>C;

   procedure raptor_parser_set_namespace_handler (Parser: Handle_Type; Data: chars_ptr; Handler: raptor_namespace_handler)
      with Import, Convention=>C;

   procedure raptor_parser_set_uri_filter (Parser: Handle_Type; Handler: raptor_uri_filter_func; Data: chars_ptr)
      with Import, Convention=>C;
